...
filEndDate cbStatus bundo Btn_OK Btn_Cancel 
...
DEFINE FRAME gDialog
     ...
     bundo AT ROW 10.29 COL 40 WIDGET-ID 20
...
------------------------------------------------------------------------------*/
  DISPLAY cmbDescription cmbcategory filStart filEndDate cbStatus 
      WITH FRAME gDialog.
  ENABLE RECT-3 cmbDescription cmbcategory filStart filEndDate cbStatus bundo 
         Btn_OK Btn_Cancel 
      WITH FRAME gDialog.
  VIEW FRAME gDialog.
