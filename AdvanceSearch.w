...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS brwUser gDialog _FREEFORM
  QUERY brwUser DISPLAY
    ...
    ttUser.ttfirstName LABEL "first name" format "x(10)"
    ttUser.ttlastName  LABEL "last name" format "x(10)"
    ttUser.ttphone LABEL "phone" format "x(14)"
    ttUser.ttemaiid LABEL "email" format "x(20)"
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
